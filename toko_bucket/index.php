            ...
            <div class="box-beranda">
                ...
                if (mysqli_num_rows($kategori) > 0) {
                    while ($k = mysqli_fetch_array($kategori)) {
                        // Assign different images for different categories
                        switch($k['categori_name']) {
                            case 'Bucket Bunga':
                                $image = 'img/WhatsApp Image 2024-06-26 at 05.48.35_3139de31.jpg';
                                break;
                            case 'Bucket Wisuda':
                                $image = 'img/bucket_wisuda.jpg';
                                break;
                            case 'Bucket Snack':
                                $image = 'img/bucket_snack.jpg';
                                break;
                            case 'Bucket Uang':
                                $image = 'img/bucket_uang.jpg';
                                break;
                            case 'Bucket Boneka':
                                $image = 'img/bucket_wisuda.jpg';
                                break;
                            ...
                            default:
                                $image = 'img/flower-01.jpg';
                                break;
                        }
                ?>
                        <div class="col-5">
                            <a href="produk.php?kategori=<?php echo $k['categori_id']; ?>&categori_name=<?php echo urlencode($k['categori_name']); ?>">
                                <img src="<?php echo $image; ?>" style="margin-bottom:5px;">
                                <p><?php echo htmlspecialchars($k['categori_name']); ?></p>
                            </a>
                        </div>
                <?php 
                    }
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box-beranda">
                ...
                // Menangkap parameter kategori_name dari URL
                $kategori_name = isset($_GET['categori_name']) ? mysqli_real_escape_string($conn, $_GET['categori_name']) : '';
                ...
                if (!empty($kategori_name)) {
                    $where .= " AND product_name LIKE '%" . mysqli_real_escape_string($conn, $kategori_name) . "%'";
                }

                $produk = mysqli_query($conn, "SELECT * FROM tb_product $where ORDER BY product_id DESC LIMIT 8");
        ...
        <div class="footer">
            <div class="container">
                ...
                <div class="footer-section social-media">
                    <h4>Ikuti Kami</h4>
                    <a href="https://www.facebook.com/flower<a href="https://www.facebook.com/profile.php?id=61559603363216" target="_blank"><i class="fab fa-facebook"></i> Facebook</a>
