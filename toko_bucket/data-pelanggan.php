...
<head>
    ...
    <title>Data Pelanggan - FlowerlyBucket</title>
    <style>
        .header-logo {
            display: flex;
            align-items: center;
...
<body>
  ...
  <div class="section">
    <div class="container">
        ...
        <div class="box">
            <p><a href="tambah-pelanggan.php">Tambah Pelanggan</a></p>
            <br>
            <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="edit-pelanggan.php?id=<?php echo $row['pelanggan_id']?>">Edit</a> || <a href="proses-hapus.php?idpelanggan=<?php echo $row['pelanggan_id']?>" onclick="return confirm('Yakin ingin hapus?')">Hapus</a></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
